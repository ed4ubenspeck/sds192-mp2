...
state_plot <- function(state_arg){
  join_for_wins(state_arg) %>%
    ...
    scale_fill_manual(values = c(W = "orange", N = "yellow")) + 
    ...
    scale_color_manual(breaks = c("N", "W"), labels = c("No Win", "Win"), values = c(W = "orange", N = "yellow"))
}
...
=======
>>>>>>> 4d79a59ebea7b286291370962bc7a796346dbed7
=======
# defining populous states to plot for
>>>>>>> 917348bf5d59685cfd9283bcd13952d6eb0d684f
...
<<<<<<< HEAD
                     "IL")
>>>>>>> 319d3c6ba2fca8bee6a9c0dc4f5669d96bcfc51d
=======
                     "IL",
                     "OH")
>>>>>>> 53802a523531ab2252d83bb2d5dccf5716d2d812

<<<<<<< HEAD
example2 <- join_for_wins("AZ")
example3 <- join_for_wins("CA")
state_plot("CA")
>>>>>>> b86a7182242fc4aba1b0a3db479d3c2703f4211a
